...
- `raw/clinvar/`: Git-ignored destination for the fixed compressed historical summary pair and provenance sidecars.
...
- `tmp/`: Git-ignored temporary processing space; full releases should not be extracted here.
