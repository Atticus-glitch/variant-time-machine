...
AI_HOLDOUT_V6_CONFIG_PATH = PROJECT_ROOT / "config" / "ai_holdout_v6.yaml"
...
MODEL_ERROR_REVIEW_PATH = DATA_DIR / "manual_review" / "model_error_reviews.json"
...
REQUIRED_DIRECTORIES: tuple[Path, ...] = (
    ...
    OUTPUTS_DIR / "evaluations" / "frozen",
    OUTPUTS_DIR / "evaluations" / "experiments",
    OUTPUTS_DIR / "logs",
    OUTPUTS_DIR / "leakage_audits",
    OUTPUTS_DIR / "error_analysis",
    MODEL_REGISTRY_DIR,
...
IMPORTANT_FILES: tuple[Path, ...] = (
    ...
    PROJECT_ROOT / "research" / "ai-holdout-v5-training.md",
    ...
    PROJECT_ROOT / "research" / "ai-temporal-v8-results.md",
    ...
    PROJECT_ROOT / "research" / "project-summary-for-mentors.md",
    PROJECT_ROOT / "research" / "mit-activity-draft.md",
    PROJECT_ROOT / "research" / "mit-activity-description-draft.md",
    PROJECT_ROOT / "research" / "strongest-truthful-claim.md",
    PROJECT_ROOT / "research" / "v8-case-studies.md",
    PROJECT_ROOT / "research" / "v8-error-analysis.md",
    PROJECT_ROOT / "research" / "v8-ai-assisted-review.md",
    PROJECT_ROOT / "research" / "poster-outline.md",
    PROJECT_ROOT / "research" / "explain-to-mentor.md",
    PROJECT_ROOT / "research" / "v9-model-selection-plan.md",
    PROJECT_ROOT / "research" / "v9-clean-dataset-and-model-report.md",
    PROJECT_ROOT / "research" / "v9-mentor-summary.md",
    PROJECT_ROOT / "research" / "admissions-research-timeline.md",
    ...
    PROJECT_ROOT / "config" / "v9_exploratory.json",
    PROJECT_ROOT / "config" / "manual_review_schema.yaml",
    ...
    PROJECT_ROOT / "src" / "variant_time_machine" / "v8_ai_review.py",
    PROJECT_ROOT / "src" / "variant_time_machine" / "v9_dataset.py",
    PROJECT_ROOT / "src" / "variant_time_machine" / "v9_exploratory.py",
    ...
    PROJECT_ROOT / "scripts" / "build_v8_presentation.py",
    PROJECT_ROOT / "scripts" / "build_v9_dataset.py",
    PROJECT_ROOT / "scripts" / "review_v8_errors_with_snapshots.py",
    PROJECT_ROOT / "scripts" / "run_v9_exploratory.py",
    ...
    PROJECT_ROOT / "tests" / "test_v8_presentation.py",
    PROJECT_ROOT / "tests" / "test_v8_dashboard.py",
    PROJECT_ROOT / "tests" / "test_v9_dataset.py",
    PROJECT_ROOT / "tests" / "test_v8_ai_review.py",
    PROJECT_ROOT / "tests" / "test_v9_exploratory.py",
    FIGURES_DIR / ".gitkeep",
    TABLES_DIR / ".gitkeep",
    MODELS_DIR / ".gitkeep",
    ...
    PROJECT_ROOT / "website" / "dashboard" / "model_versions.html",
    PROJECT_ROOT / "website" / "dashboard" / "prediction_explorer.html",
    PROJECT_ROOT / "website" / "dashboard" / "research_timeline.html",
    PROJECT_ROOT / "website" / "dashboard" / "v8_results.html",
    PROJECT_ROOT / "website" / "dashboard" / "v8_review.html",
    PROJECT_ROOT / "website" / "dashboard" / "v9_dataset.html",
    PROJECT_ROOT / "website" / "dashboard" / "v9_training.html",
    PROJECT_ROOT / "website" / "dashboard" / "v9_results.html",
    PROJECT_ROOT / "website" / "dashboard" / "v9_explorer.html",
    ...
    PROJECT_ROOT / "website" / "dashboard" / "static" / "model_versions.js",
    PROJECT_ROOT / "website" / "dashboard" / "static" / "prediction_explorer.js",
    PROJECT_ROOT / "website" / "dashboard" / "static" / "research_timeline.js",
    PROJECT_ROOT / "website" / "dashboard" / "static" / "v8_results.js",
    PROJECT_ROOT / "website" / "dashboard" / "static" / "v8_review.js",
    PROJECT_ROOT / "website" / "dashboard" / "static" / "v9_status.js",
    MODEL_REGISTRY_INDEX_PATH,
    MODEL_REGISTRY_DIR / "model_v4.json",
    MODEL_REGISTRY_DIR / "model_v5.json",
    MODEL_REGISTRY_DIR / "model_v7.json",
    MODEL_REGISTRY_DIR / "model_v8.json",
    OUTPUTS_DIR / "evaluations" / "frozen" / "v4_metrics.json",
    ...
    OUTPUTS_DIR / "evaluations" / "frozen" / "v8_metrics.json",
    OUTPUTS_DIR / "evaluations" / "frozen" / "v8_protocol_audit.json",
    OUTPUTS_DIR / "evaluations" / "frozen" / "v8_vault_commitment.json",
    OUTPUTS_DIR / "evaluations" / "frozen" / "v8_model_commitment.json",
    OUTPUTS_DIR / "evaluations" / "frozen" / "v8_public_summary.json",
    ...
    OUTPUTS_DIR / "leakage_audits" / "v8_leakage_audit.json",
    OUTPUTS_DIR / "error_analysis" / "model_v4_errors.csv",
    OUTPUTS_DIR / "error_analysis" / "model_v5_errors.csv",
    OUTPUTS_DIR / "error_analysis" / "model_v8_errors.csv",
    OUTPUTS_DIR / "error_analysis" / "v8_all_rows.csv",
    OUTPUTS_DIR / "case_studies" / "v8_case_studies.json",
    OUTPUTS_DIR / "manual_review" / "v8_review_queue.csv",
    OUTPUTS_DIR / "manual_review" / "v8_review_queue_manifest.json",
    OUTPUTS_DIR / "manual_review" / "v8_review_notes.json",
    OUTPUTS_DIR / "manual_review" / "v8_ai_review_suggestions.json",
    PROJECT_ROOT / "src" / "variant_time_machine" / "v8_presentation.py",
    PROJECT_TIMELINE_PATH,
    MODEL_ERROR_REVIEW_PATH,
    PROJECT_ROOT / "docs" / "data-dictionary.md",
    PROJECT_ROOT / "docs" / "manual-review-schema.md",
    PROJECT_ROOT / "docs" / "v9-inclusion-rules.md",
